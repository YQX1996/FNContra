...
j = 4
checkpoint = r"G:\FNContra\train_results\FNContra-new\all\1024\skulls\models\all_30000.pth"
...
imgs = torch.cat(imgs)
vutils.save_image(imgs.add(1).mul(0.5), 'style_mix_skulls.jpg', nrow=bs+1)